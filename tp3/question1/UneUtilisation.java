...
public class UneUtilisation {
    ...
    public static void main(String[] args) throws Exception {
        ...
        p1.empiler(p2);
        System.out.println(" la p1 = " + p1); // Quel est le résultat ? la p1=[1000]

        try {
            p1.empiler(new PolygoneRegulier(4,100));
            // ....
            String s = (String) p1.depiler(); // vérifiez qu'une exception se
            // produit :java.lang.ClassCastException because polygone regulier cannot be cast to java.lang.String
        } catch (Exception e) {
            e.printStackTrace();
        } // catch
    } // main()
